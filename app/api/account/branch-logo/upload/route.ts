...
/* ======================================================
   POST /api/account/branch-logo/upload
   - Upload LOGO SHOP (theo tenant_id)
   - Ghi đè logo cũ
...
export async function POST(req: Request) {
  try {
    ...
    /* ================= STORAGE PATH ================= */
    // ✅ LOGO SHOP – 1 FILE DUY NHẤT CHO TENANT
    const storagePath = `${tenant_id}/logo/logo.jpg`;
